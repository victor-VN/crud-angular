...
let JogadorCriarComponent = class JogadorCriarComponent {
    constructor(_jogadorService) {
...
JogadorCriarComponent.ctorParameters = () => [
...
let JogadorListaComponent = JogadorListaComponent_1 = class JogadorListaComponent {
    constructor(_jogadorService) {
        this._jogadorService = _jogadorService;
        this.jogadores = [];
        this.playerID = 0;
    ...
    ngOnInit() {
        ...
        _jogador_jogador_service__WEBPACK_IMPORTED_MODULE_1__["JogadorService"].emitirJogador.subscribe(novoJogador => this.jogadores = novoJogador);
...
JogadorListaComponent.ctorParameters = () => [
    { type: _jogador_jogador_service__WEBPACK_IMPORTED_MODULE_1__["JogadorService"] }
];
...
let JogadorComponent = class JogadorComponent {
    constructor(_jogadorService) {
        this._jogadorService = _jogadorService;
        this.jogador = [];
        this.id = 0;
    ...
    ngOnInit() {
        ...
        _jogador_service__WEBPACK_IMPORTED_MODULE_2__["JogadorService"].emitirJogador.subscribe(player => this.jogador = player);
        //console.log(this.jogador);   
        //console.log(this.jogador.length);    
        _jogador_lista_jogador_lista_component__WEBPACK_IMPORTED_MODULE_1__["JogadorListaComponent"].emitirPlayerID.subscribe(playerId => {
...
JogadorComponent.ctorParameters = () => [
...
let JogadorService = JogadorService_1 = class JogadorService {
    constructor() {
        this.jogador = [];
    }
